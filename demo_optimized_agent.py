"""
Live Demonstration: Optimized Code Reviewer Agent
This script demonstrates the agent running with automatically-loaded optimized instructions.
"""
...
print("="*80)
print("🎯 Code Reviewer Agent - Live Demonstration")
print("="*80)
print()

# Initialize pipeline (will auto-load optimized instructions)
print("📦 Loading Code Reviewer Pipeline...")
...
if pipeline.is_trained:
    ...
    print("   Run 'python optimize_code_reviewer.py' to generate optimized instructions!")
